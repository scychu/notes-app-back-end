...
exports.up = (pgm) => {
 ...
 pgm.addConstraint('collaborations', 'fk_collaborations.note_id_and_notes.id', 'FOREIGN KEY(note_id) REFERENCES notes(id) ON DELETE CASCADE');
 pgm.addConstraint('collaborations', 'fk_collaborations.user_id_and_users.id', 'FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE');
};
